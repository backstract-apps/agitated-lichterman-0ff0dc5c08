...
async def cors_middleware(request: Request) -> Dict[str, Any]:
    """
    CORS Middleware
    Generated from middleware ID: mid_d09e03e4ffdd4bf4bb1f70161a6d7969
    """
    try:
...
async def auth_package_middleware(request: Request) -> Dict[str, Any]:
    ...
    Generated from middleware ID: mid_14c19dba8e254c8593c0af1a0bece817
    """
    try:
        ...
        auth_package_secret_key = """kTV8IXOqGjQgCqkjpbW1xoqeHSkARTVX9y_IseHIWIA="""
